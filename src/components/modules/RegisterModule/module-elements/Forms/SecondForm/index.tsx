...
const SecondForm: React.FC = () => {
    ...
    return (
        <div className="mx-auto my-4 p-4">
            <span className="flex text-crayola text-xl font-semibold mb-4">Select Your Favorite Genres</span>
            <FavoriteGenre
            ...
            {errors.genres && <p className="text-[#f71e3f] mt-2">Please select at least one genre</p>}
            {selectedGenres.length > 5 && <p className="text-[#f71e3f] mt-2">You can select up to 5 genres only</p>}
        </div>
    );
}
